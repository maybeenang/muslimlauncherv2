...
extension UserProfileQueryFilter
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> pointsEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'points',
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> pointsLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterFilterCondition> pointsBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension UserProfileQuerySortBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByPoints() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'points', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> sortByPointsDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQuerySortThenBy
  ...
  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByPoints() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'points', Sort.asc);
    });
  }

  QueryBuilder<UserProfile, UserProfile, QAfterSortBy> thenByPointsDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'points', Sort.desc);
    });
  }
...
extension UserProfileQueryWhereDistinct
  ...
  QueryBuilder<UserProfile, UserProfile, QDistinct> distinctByPoints() {
    return QueryBuilder.apply(this, (query) {
...
extension UserProfileQueryProperty
  ...
  QueryBuilder<UserProfile, int, QQueryOperations> pointsProperty() {
    return QueryBuilder.apply(this, (query) {
